...
public class TrustYourDestiny {
	static final String y = "YONSEI";
	static final String k = "KOREA";
	static int yidx, kidx;
	public static void main(String[] args) throws IOException {
		for (char c : r().toCharArray()) {
			if (y.charAt(yidx) == c) yidx++;
			if (k.charAt(kidx) == c) kidx++;
			if (yidx == 6) {
				sb.append(y);
				break;
			}
