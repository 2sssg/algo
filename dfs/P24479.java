...
public class P24479 {
	...
	public static void main(String[] args) throws IOException {
		init();
		System.out.println("씨발 여기까진 오냐? 1");
		dfs(s);
		System.out.printf("s : %d\n", s);
		System.out.println("씨발 여기까진 오냐? 2");
		for (int i = 1; i <= n; ++i) sb.append(seq[i]).append("\n");
	...
	static void testPrint(List[] adjList) {System.out.println(Arrays.toString(adjList));}
